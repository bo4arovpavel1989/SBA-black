...
/***/ function(module, exports, __webpack_require__) {
	...
	window.__gooseParse = function (rule, offset, scopes) {
	    ...
	    var BrowserEnvironment = __webpack_require__(2);
	    var Parser = __webpack_require__(10);
	    var env = new BrowserEnvironment();
	    var parser = new Parser({ environment: env });

	    delete rule.inject;
	    console.log('Injection..');
	    parser._scopes = scopes;
	    parser.clearDom = true;
	    parser._parseScope(rule, offset).then(function (results) {
	        return window.__gooseResults = results;
	    }, function (error) {
	        return window.__gooseError = error;
	    });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Environment = __webpack_require__(3),
	    debug = __webpack_require__(7)('BrowserEnvironment'),
	    vow = __webpack_require__(4);
	...
	BrowserEnvironment.prototype = _.create(Environment.prototype, /**@lends BrowserEnvironment*/{
	    evaluateJs: function evaluateJs() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var vow = __webpack_require__(4),
	    debug = __webpack_require__(7)('Environment');
	...
	Environment.prototype = {
	     ...
	     * @returns {Promise}
	     */
	    waitForPage: function waitForPage(timeout) {
	    ...
	    addErrback: function addErrback(errback) {
	        this._errbacks.push(errback);
	    },

	    removeErrback: function removeErrback(errback) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(5).setImmediate, __webpack_require__(6)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debugLib = __webpack_require__(7),
	    debug = debugLib('Parser'),
	    _ = __webpack_require__(11),
	    vow = __webpack_require__(4),
	    Paginator = __webpack_require__(13),
	    Actions = __webpack_require__(14),
	    Transformations = __webpack_require__(42),
	    Storage = __webpack_require__(15);
	var actionsFactory = __webpack_require__(16);
	var MAX_MILESTONE_ATTEMPTS = 2;
	...
	Parser.prototype = {
	    ...
	    parse: function parse(options) {
	        ...
	        var results;
	        return this._env.prepare().then(function () {
	            if (_this._preActions) {
	                return _this._actions.performActions(_this._preActions);
	            }
	            return vow.resolve();
	        })
	        ...
	        .then(this._parseRootRule, this).then(function (parsedResults) {
	            ...
	            _this._partialResults = results;
	            throw e;
	        });
	    },

	    moveYourFeet: function moveYourFeet(stages) {
	        var _this2 = this;

	        debug('Hit the road!');
	        var milestones = stages.milestones;
	        var edgeCases = stages.edgeCases;

	        return this._env.prepare().then(function () {
	            return milestones.reduce(function (promise, milestone) {
	                return promise.then(function () {
	                    return _this2.passMilestone(milestone, edgeCases);
	                });
	            }, Promise.resolve());
	        }).then(function () {
	            return _this2._env.tearDown();
	        }, function (e) {
	            return _this2._env.snapshot('error').always(function () {
	                return _this2._env.tearDown();
	            }).then(function () {
	                throw e;
	            });
	    ...
	    passMilestone: function passMilestone(milestone, edgeCases, attemptNumber) {
	        var _this3 = this;

	        attemptNumber = attemptNumber || 0;
	        debug('Passing %o milestone, attempt #%s', milestone, attemptNumber);
	        return this._actions.performActions(milestone.condition).then(function (result) {
	            if (!result) {
	                debug('Milestone condition failed');
	                return _this3.catchFailedMilestone(milestone, edgeCases, attemptNumber, 'Milestone condition failed');
	            }

	            debug('Milestone condition passed, passing milestone');
	            return _this3.processRule(milestone.rules, 0);
	        })['catch'](function (e) {
	            debug('Caught milestone error %o', e.stack || e);
	            return _this3.catchFailedMilestone(milestone, edgeCases, attemptNumber, e);
	        });
	    },

	    catchFailedMilestone: function catchFailedMilestone(milestone, edgeCases, attemptNumber, originalError) {
	        var _this4 = this;
	        ...
	        return this.handleEdgeCases(edgeCases).then(function (edgeCasesHandled) {
	            if (!edgeCasesHandled) {
	                debug('Catching edge cases failed');
	                return _this4.catchFailedMilestone(milestone, edgeCases, attemptNumber + 1, originalError);
	            }

	            debug('Edge case handled, another try to pass milestone');
	            return _this4.passMilestone(milestone, edgeCases, attemptNumber + 1);
	        });
	    },

	    handleEdgeCases: function handleEdgeCases(edgeCases) {
	        var _this5 = this;

	        return edgeCases.reduce(function (promise, edgeCase) {
	            return promise.then(function (result) {
	                if (result) {
	                    return Promise.resolve(result);
	                }

	                return _this5.handleEdgeCase(edgeCase);
	            });
	        }, Promise.resolve(false));
	    },

	    handleEdgeCase: function handleEdgeCase(edgeCase) {
	        var _this6 = this;

	        debug('Handling edge case %o', edgeCase);
	        return this._actions.performActions(edgeCase.condition).then(function (result) {
	            if (!result) {
	            ...
	            return _this6.processRule(edgeCase.rules, 0);
	        })['catch'](function (e) {
	    ...
	    getPartialResults: function getPartialResults() {
	     ...
	     */
	    addTransformation: function addTransformation() {
	     ...
	     * @private
	     */
	    _parseRootRule: function _parseRootRule(offset) {
	        offset = offset || 0;
	     ...
	     * @private
	     */
	    _pushScope: function _pushScope(scope, parentScope) {
	     ...
	     * @returns {Promise}
	     */
	    processRule: function processRule(rule, offset) {
	        var _this7 = this;
	        ...
	        return this._actions.performForRule(rule, selector).then(function (actionsResults) {
	            ...
	            if (rule.rulesFromActions) {
	                ...
	                if ('scope' in actionsResults) {
	                    _this7._pushScope(actionsResults.scope, actionsResults.parentScope);
	                    scopePushed = true;
	                }
	                ...
	                if ('actions' in rule) {
	                    promise = promise.then(function () {
	                        return _this7._actions.performForRule(rule, selector);
	                    });
	                }
	            }

	            promise = promise.then(function () {
	                return _this7._parseScope(rule, offset, actionsResults);
	            });
	    ...
	    _parseScope: function _parseScope(rule, offset, actionsResults) {
	        ...
	        var extract = function extract(results, ruleType, dataType) {
	            if (ruleType === _this8.TYPES.SIMPLE && dataType === 'array' && Array.isArray(results) && results.length === 1 && Array.isArray(results[0])) {
	        ...
	        var format = function format(results) {
	            if (_.contains([_this8.TYPES.SIMPLE, _this8.TYPES.GET, _this8.TYPES.VALUE, _this8.TYPES.COLLECTION], ruleType)) {
	        ...
	        var updateResultsInStore = function updateResultsInStore(results) {
	            if (rule.set) {
	                _this8._actions.set(rule.set, results);
	            }
	            if (rule.add) {
	                var current = _this8._actions.get(rule.add) || [];
	                current.push(results);
	                _this8._actions.set(rule.add, current);
	            }
	            if (rule.unset) {
	                _this8._actions.unset(rule.unset);
	            }
	            return results;
	        };

	        if (!rule.transform) {
	            return resultsPromise.then(format).then(updateResultsInStore);
	        }

	        return resultsPromise.then(function (results) {
	            return format(_this8.transform(results, rule.transform));
	        }).then(function (results) {
	            return extract(results, ruleType, rule.type);
	        }).then(updateResultsInStore);
	    },

	    transform: function transform(results, _transform) {
	        if (Array.isArray(results)) {
	            results = results.map(function (result) {
	                if (typeof result === 'string') {
	                    result = result.trim();
	                }
	                return this._transforms.produce(_transform, result);
	            }, this);
	        } else {
	            results = this._transforms.produce(_transform, results);
	        }
	     ...
	     * @returns {string}
	     */
	    _getRuleType: function _getRuleType(rule) {
	        if (rule.inject) {
	     ...
	     * @private
	     */
	    _parseGridRule: function _parseGridRule(rule, offset) {
	        var _this9 = this;

	        debug('._parseGridRule() has called');
	        offset = offset || 0;
	        var collection = rule.collection[0];
	        return this._env.evaluateJs(this._getSelector(), /* @covignore */function (selector) {
	            ...
	            var scope = _this9._popScope();
	            return _this9._parseRow({
	                collection: collection,
	     ...
	     * @private
	     */
	    _parseRow: function _parseRow(options) {
	        ...
	        return this._parseCollectionRule({
	    ...
	    _injectBrowserRule: function _injectBrowserRule(rule, offset, actionsResults) {
	        var _this10 = this;

	        debug('._injectBrowserRule()');
	        var internalGooseResults = undefined,
	            internalGooseError = undefined;
	        return this._env.injectBrowserEnv().then(function () {
	            return _this10._env.evaluateJs(rule, offset, _this10._scopes, function (rule, offset, scopes) {
	                __gooseParse(rule, offset, scopes);
	            });
	        }).then(function () {
	            return _this10._actions.wait(function () {
	                return [__gooseResults, __gooseError];
	            }, function (resultsToCheck) {
	                internalGooseResults = resultsToCheck[0];
	                internalGooseError = resultsToCheck[1];
	                return internalGooseResults || internalGooseError;
	            }, null, rule.injectionTimeout);
	        }).then(function () {
	     ...
	     * @private
	     */
	    _parseCollectionRule: function _parseCollectionRule(rule) {
	        var _this11 = this;
	        ...
	        return collection.reduce(function (promise, rule) {
	            return promise.then(function () {
	                return _this11.processRule(rule);
	            }).then(function (result) {
	                var name;
	                switch (typeof rule.id) {
	                    ...
	                    case 'function':
	                        name = '_id';
	                        result = rule.id.call(_this11, rule, result);
	                        break;
	                    default:
	                        name = rule.name;
	                }
	     ...
	     * @private
	     */
	    _parseSimpleRule: function _parseSimpleRule(rule) {
	        var selector = this._getSelector();
	        var filter = {
	            type: 'text'
	        };
	    ...
	    _paginate: function _paginate(results) {
	        if (!this._paginator) {
	            return vow.resolve(results);
	        }

	        debug('Pagination...');
	        return this._paginator.paginate().then(function (pagination) {
	            if (pagination.done) {
	                return vow.resolve(results);
	            }
	            ...
	            return this._parseRootRule(offset).then(function (pageResults) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(7)('Paginator'),
	    vow = __webpack_require__(4);
	...
	Paginator.prototype = {
	     ...
	     * @returns {number}
	     */
	    getMaxResultsCount: function getMaxResultsCount() {
	     ...
	     */
	    addPagination: function addPagination(type, paginateFn, checkPaginateFn, resetOffset) {
	    ...
	    resetCollectionOffsetOnNewPage: function resetCollectionOffsetOnNewPage() {
	        var customPagination = this._customPagination[this._type];
	        if (customPagination) {
	     ...
	     * @private
	     */
	    _paginateCustom: function _paginateCustom(paginateFn, checkPaginateFn, options) {
	        return paginateFn.call(this, options).then(function () {
	     ...
	     * @private
	     */
	    _paginateScroll: function _paginateScroll() {
	        var previousHeight;
	        return this._env.evaluateJs( /* @covignore */function () {
	            return document.body.scrollHeight;
	        }).then(function (height) {
	            previousHeight = height;
	        }).then(this._actions.scroll.bind(this._actions, this._scrollInterval)).then(function () {
	     ...
	     * @private
	     */
	    _getRealNextPageIndex: function _getRealNextPageIndex() {
	     ...
	     * @private
	     */
	    _paginatePage: function _paginatePage() {
	        var selector;
	        var previousPageHtml;
	        return this._getRealNextPageIndex().then(function (realPageIndex) {
	            ...
	            switch (this._strategy) {
	                ...
	                case this.STRATEGY.AJAX:
	                    ...
	                    break;
	                case null:
	                    paginationPromise = vow.any([this._env.waitForPage(this._timeout).then(function () {
	                        this._strategy = this.STRATEGY.NEW_PAGE;
	                        debug('Set strategy to %s', this._strategy);
	                    }, this), this._hasPageDataChanged(previousPageHtml).then(function () {
	     ...
	     * @private
	     */
	    _paginateShowMore: function _paginateShowMore() {
	        var _this = this;

	        var selector = this._scope;
	        var previousPageHtml;
	        return this._env.evaluateJs(this._pageScope, this._getPaginatePageHtml).then(function (html) {
	            previousPageHtml = html;
	        }).then(function () {
	            return vow.all([_this._actions.click(selector), _this._hasPageDataChanged(previousPageHtml)]);
	        }).then(function () {
	            debug('page %s opened', _this._currentPage);
	            return {
	                value: _this._currentPage,
	                done: false
	            };
	        }, function (e) {
	            debug('Cannot paginate anymore after %s page, because of error %s', _this._currentPage, e.message);
	            return {
	                done: true
	            };
	        });
	     ...
	     * @private
	     */
	    _getPaginatePageHtml: /* @covignore */function _getPaginatePageHtml(selector) {
	     ...
	     * @private
	     */
	    _hasPageScrolled: function _hasPageScrolled(previousPageHeight) {
	     ...
	     * @private
	     */
	    _hasPageDataChanged: function _hasPageDataChanged(previousPageHtml) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(7)('Actions');
	var vow = __webpack_require__(4);
	var _ = __webpack_require__(11);
	var Storage = __webpack_require__(15);
	var actionsFactory = __webpack_require__(16);
	var _wait = __webpack_require__(25);
	...
	Actions.prototype = {
	     ...
	     * @returns {Promise}
	     */
	    performForRule: function performForRule(rule, parentSelector) {
	        var _this = this,
	        ...
	        var promise = this.performActions(actions, parentSelector);
	        var possibleErrors = rule.catchError;
	        if (possibleErrors) {
	            ...
	            promise = promise['catch'](function (reason) {
	                ...
	                return _this._handleError(possibleErrors[reason.name], _arguments);
	            });
	        }
	    ...
	    _handleError: function _handleError(handlerDescription, actionArgs) {
	        ...
	        switch (handlerDescription.handler) {
	            case 'repeat':
	                ...
	                return this.performForRule.apply(this, actionArgs).then(function (results) {
	     ...
	     * @returns {Promise}
	     */
	    performPostActionsForRule: function performPostActionsForRule(rule, parentSelector) {
	     ...
	     * @returns {Promise}
	     */
	    performActions: function performActions(actions, parentSelector) {
	        ...
	        return actions.reduce(function (promise, action) {
	            ...
	            return promise.then(function (previousActionResult) {
	     ...
	     * @private
	     */
	    _performAction: function _performAction(action, parentSelector, previousActionResult) {
	        var _this2 = this;
	        ...
	        if (action.waitForQuery) {
	            var waitAction = _.merge({}, action.waitForQuery, {
	        ...
	        if (action.transform) {
	            actionPromise = actionPromise.then(function (results) {
	                return _this2._parser.transform(results, action.transform);
	            });
	        }

	        if (action.set) {
	            actionPromise = actionPromise.then(function (results) {
	                _this2.set(action.set, results);
	                return results;
	            });
	        }
	    ...
	    _performCases: function _performCases(cases, parentSelector, previousActionResult) {
	        ...
	        var promises = cases.map(function (actions, caseNumber) {
	            ...
	            return actions.slice(1).reduce((function (promise, action, i, array) {
	                return promise.then(function () {
	            ...
	            }).bind(this), beginningPromise).then(function (results) {
	                if (wonCase === null) {
	                    wonCase = caseNumber;
	                    debug('Won case with actions %o', cases[wonCase]);
	                }
	     ...
	     * @returns {Promise}
	     */
	    wait: function wait(evalFunction, checkerFunction, args, timeout, interval) {
	        return _wait(this._env, evalFunction, checkerFunction, args, timeout, interval);
	    },
	     ...
	     * @returns {Promise}
	     */
	    scroll: function scroll(interval) {
	     ...
	     * @returns {Promise}
	     */
	    performConditionalActions: function performConditionalActions(selector, conditions, actions, elseActions) {
	        var _this3 = this;

	        return this.performActions(conditions, selector).then(function (result) {
	            if (!result) {
	                debug('Conditional actions failed with result %s, skip %o', result, actions);
	                return elseActions ? _this3.performActions(elseActions, selector) : false;
	            }

	            debug('Conditional actions return %s, go with real some', result);
	            return _this3.performActions(actions, selector);
	        });
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(7)('Storage'),
	    _ = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actionsMap = {
	    click: __webpack_require__(18),
	    mouseClick: __webpack_require__(19),
	    mousedown: __webpack_require__(20),
	    mouseup: __webpack_require__(21),
	    changeElement: __webpack_require__(22),
	    wait: __webpack_require__(23),
	    waitForVisible: __webpack_require__(26),
	    waitForPattern: __webpack_require__(27),
	    waitForPage: __webpack_require__(28),
	    waitForQuery: __webpack_require__(29),
	    pause: __webpack_require__(30),
	    parse: __webpack_require__(31),
	    type: __webpack_require__(32),
	    exist: __webpack_require__(33),
	    hasRedirect: __webpack_require__(34),
	    back: __webpack_require__(35),
	    provideRules: __webpack_require__(36),
	    snapshot: __webpack_require__(37),
	    open: __webpack_require__(38),
	    focus: __webpack_require__(39),
	    blur: __webpack_require__(40),
	    url: __webpack_require__(41)
	};

	var actionsFactory = {
	    createAction: function createAction(options) {
	        var ActionConstructor = actionsMap[options.actionOptions.type];
	     ...
	     */
	    addAction: function addAction(type, action) {
	        ...
	        var CustomAction = (function (_Action) {
	            _inherits(CustomAction, _Action);

	            function CustomAction() {
	                _classCallCheck(this, CustomAction);

	                _get(Object.getPrototypeOf(CustomAction.prototype), 'constructor', this).apply(this, arguments);
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(7)('Action');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionClick = (function (_Action) {
	    _inherits(ActionClick, _Action);

	    function ActionClick() {
	        _classCallCheck(this, ActionClick);

	        _get(Object.getPrototypeOf(ActionClick.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionClick, [{
	        key: 'perform',
	        value: function perform() {
	            var _this = this;

	            this.log('click by %s', this._selector);
	            return this._env.evaluateJs(this._selector, /* @covignore */function (selector) {
	                var nodes = Sizzle(selector);
	                ...
	                return _this.log('clicked %s nodes', len);
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionMouseClick = (function (_Action) {
	    _inherits(ActionMouseClick, _Action);

	    function ActionMouseClick() {
	        _classCallCheck(this, ActionMouseClick);

	        _get(Object.getPrototypeOf(ActionMouseClick.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionMouseClick, [{
	        key: 'perform',
	        value: function perform() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionMousedown = (function (_Action) {
	    _inherits(ActionMousedown, _Action);

	    function ActionMousedown() {
	        _classCallCheck(this, ActionMousedown);

	        _get(Object.getPrototypeOf(ActionMousedown.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionMousedown, [{
	        key: 'perform',
	        value: function perform() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionMouseup = (function (_Action) {
	    _inherits(ActionMouseup, _Action);

	    function ActionMouseup() {
	        _classCallCheck(this, ActionMouseup);

	        _get(Object.getPrototypeOf(ActionMouseup.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionMouseup, [{
	        key: 'perform',
	        value: function perform() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionChangeElement = (function (_Action) {
	    _inherits(ActionChangeElement, _Action);

	    function ActionChangeElement() {
	        _classCallCheck(this, ActionChangeElement);

	        _get(Object.getPrototypeOf(ActionChangeElement.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionChangeElement, [{
	        key: 'perform',
	        value: function perform() {
	            var changeStyleOptions = this._options.change || {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionWaitElement = (function (_ActionWait) {
	    _inherits(ActionWaitElement, _ActionWait);

	    function ActionWaitElement() {
	        _classCallCheck(this, ActionWaitElement);

	        _get(Object.getPrototypeOf(ActionWaitElement.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionWaitElement, [{
	        key: 'perform',
	        value: function perform() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionWait = (function (_Action) {
	  _inherits(ActionWait, _Action);

	  function ActionWait() {
	    _classCallCheck(this, ActionWait);

	    _get(Object.getPrototypeOf(ActionWait.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(ActionWait, [{
	     ...
	     * @returns {Promise}
	     */
	    value: function wait(evalFunction, checkerFunction, args) {
	      return _wait(this._env, evalFunction, checkerFunction, args, this._options.timeout, this._options.interval);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function wait(env, evalFunction, checkerFunction, args, timeout, interval) {
	    ...
	    return new Promise(function (resolve, reject) {
	        var errback = function errback(msg) {
	            clearTimeout(timeoutId);
	        ...
	        var intervalId = setInterval(function () {
	            env.evaluateJs.apply(env, evalArgs).then(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionWaitForVisible = (function (_ActionWait) {
	    _inherits(ActionWaitForVisible, _ActionWait);

	    function ActionWaitForVisible() {
	        _classCallCheck(this, ActionWaitForVisible);

	        _get(Object.getPrototypeOf(ActionWaitForVisible.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionWaitForVisible, [{
	        key: 'perform',
	        value: function perform() {
	            this.log(this._selector);
	            var visibility = this._options.visibility === undefined ? true : this._options.visibility;
	            return this.wait( /* @covignore */function (selector, visibility) {
	                var nodes = Array.prototype.slice.call(Sizzle(selector), 0);
	                var result = nodes.some(function (node) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionWaitForPattern = (function (_ActionWait) {
	    _inherits(ActionWaitForPattern, _ActionWait);

	    function ActionWaitForPattern() {
	        _classCallCheck(this, ActionWaitForPattern);

	        _get(Object.getPrototypeOf(ActionWaitForPattern.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionWaitForPattern, [{
	        key: 'perform',
	        value: function perform() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionWaitForPage = (function (_Action) {
	    _inherits(ActionWaitForPage, _Action);

	    function ActionWaitForPage() {
	        _classCallCheck(this, ActionWaitForPage);

	        _get(Object.getPrototypeOf(ActionWaitForPage.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionWaitForPage, [{
	        key: 'perform',
	        value: function perform() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionWaitForQuery = (function (_Action) {
	    _inherits(ActionWaitForQuery, _Action);

	    function ActionWaitForQuery() {
	        _classCallCheck(this, ActionWaitForQuery);

	        _get(Object.getPrototypeOf(ActionWaitForQuery.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionWaitForQuery, [{
	        key: 'perform',
	        value: function perform() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionPause = (function (_Action) {
	    _inherits(ActionPause, _Action);

	    function ActionPause() {
	        _classCallCheck(this, ActionPause);

	        _get(Object.getPrototypeOf(ActionPause.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionPause, [{
	        key: 'perform',
	        value: function perform() {
	            var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionParse = (function (_Action) {
	    _inherits(ActionParse, _Action);

	    function ActionParse() {
	        _classCallCheck(this, ActionParse);

	        _get(Object.getPrototypeOf(ActionParse.prototype), 'constructor', this).apply(this, arguments);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionType = (function (_Action) {
	    _inherits(ActionType, _Action);

	    function ActionType() {
	        _classCallCheck(this, ActionType);

	        _get(Object.getPrototypeOf(ActionType.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionType, [{
	        key: 'perform',
	        value: function perform() {
	            var _this = this;

	            var text = this._options.useActionsResult ? this._previousActionResult : this._options.text;
	            this.log('typing %s on %s', text, this._selector);

	            return this._env.evaluateJs(this._selector, text, /* @covignore */function (selector, text) {
	                var nodes = Sizzle(selector);
	                for (var i = 0, l = nodes.length; i < l; i++) {
	                    var node = nodes[i];
	                    node.focus();
	                ...
	                return _this.log('text types in %s nodes', len);
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionExist = (function (_Action) {
	    _inherits(ActionExist, _Action);

	    function ActionExist() {
	        _classCallCheck(this, ActionExist);

	        _get(Object.getPrototypeOf(ActionExist.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionExist, [{
	        key: 'perform',
	        value: function perform() {
	            var child = this._options.child !== undefined ? this._options.child : null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionHasRedirect = (function (_Action) {
	    _inherits(ActionHasRedirect, _Action);

	    function ActionHasRedirect() {
	        _classCallCheck(this, ActionHasRedirect);

	        _get(Object.getPrototypeOf(ActionHasRedirect.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionHasRedirect, [{
	        key: 'perform',
	        value: function perform() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionBack = (function (_Action) {
	    _inherits(ActionBack, _Action);

	    function ActionBack() {
	        _classCallCheck(this, ActionBack);

	        _get(Object.getPrototypeOf(ActionBack.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionBack, [{
	        key: 'perform',
	        value: function perform() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionProvideRules = (function (_Action) {
	    _inherits(ActionProvideRules, _Action);

	    function ActionProvideRules() {
	        _classCallCheck(this, ActionProvideRules);

	        _get(Object.getPrototypeOf(ActionProvideRules.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionProvideRules, [{
	        key: 'perform',
	        value: function perform() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionSnapshot = (function (_Action) {
	    _inherits(ActionSnapshot, _Action);

	    function ActionSnapshot() {
	        _classCallCheck(this, ActionSnapshot);

	        _get(Object.getPrototypeOf(ActionSnapshot.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionSnapshot, [{
	        key: 'perform',
	        value: function perform() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionOpen = (function (_Action) {
	    _inherits(ActionOpen, _Action);

	    function ActionOpen() {
	        _classCallCheck(this, ActionOpen);

	        _get(Object.getPrototypeOf(ActionOpen.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionOpen, [{
	        key: 'perform',
	        value: function perform() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionFocus = (function (_Action) {
	    _inherits(ActionFocus, _Action);

	    function ActionFocus() {
	        _classCallCheck(this, ActionFocus);

	        _get(Object.getPrototypeOf(ActionFocus.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionFocus, [{
	        key: 'perform',
	        value: function perform() {
	            var _this = this;
	            ...
	            return this._env.evaluateJs(this._selector, /* @covignore */function (selector) {
	                ...
	                return _this.log('focused consequently %s nodes', len);
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionBlur = (function (_Action) {
	    _inherits(ActionBlur, _Action);

	    function ActionBlur() {
	        _classCallCheck(this, ActionBlur);

	        _get(Object.getPrototypeOf(ActionBlur.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionBlur, [{
	        key: 'perform',
	        value: function perform() {
	            var _this = this;
	            ...
	            return this._env.evaluateJs(this._selector, /* @covignore */function (selector) {
	                ...
	                return _this.log('blured consequently %s nodes', len);
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionUrl = (function (_Action) {
	    _inherits(ActionUrl, _Action);

	    function ActionUrl() {
	        _classCallCheck(this, ActionUrl);

	        _get(Object.getPrototypeOf(ActionUrl.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(ActionUrl, [{
	        key: 'perform',
	        value: function perform() {
	            return this._env.evaluateJs( /* @covignore */function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(7)('Transformations');
	var moment = __webpack_require__(43);
	var Storage = __webpack_require__(15);
	var _ = __webpack_require__(11);
	var entities = __webpack_require__(51).Html5Entities;
	...
	Transformations.prototype = {
	     ...
	     * @returns {*}
	     */
	    produce: function produce(transformations, result) {
	        var _this = this;
	        ...
	        return transformations.reduce(function (result, step) {
	            ...
	            var transformedResult = undefined;

	            result = typeof result === 'undefined' ? '' : result;

	            switch (step.type) {
	                case _this.TYPES.DATE:
	                    transformedResult = moment(result, step.from, step.locale || 'en').format(step.to);
	                    break;

	                case _this.TYPES.REPLACE:
	                    re = step.re;
	                    if (!Array.isArray(re)) {
	                ...
	                case _this.TYPES.MATCH:
	                    ...
	                    if (matches) {
	                        ...
	                        var matchedIndex = index.find(function (particularIndex) {
	                ...
	                case _this.TYPES.SPLIT:
	                    index = step.index || 0;
	                    var separator = Array.isArray(step.separator) ? RegExp.apply(null, step.separator) : step.separator || ',';
	                    var dataType = step.dataType || 'string';
	                ...
	                case _this.TYPES.COMPARE:
	                    transformedResult = result === _this._storage.get(step.field);
	                    break;

	                case _this.TYPES.EQUAL:
	                    transformedResult = result === step.value;
	                    break;

	                default:
	                    var customTransformation = _this._customTransformations[step.type];
	                    if (!customTransformation) {
	                        throw new Error('Unsupported transformation type: ' + step.type);
	                    }

	                    transformedResult = customTransformation.call(_this, step, result);
	                    break;
	            }
	     ...
	     */
	    addTransformation: function addTransformation(type, transformation) {
